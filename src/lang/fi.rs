...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Three-Finger horizontally", "Kolmen sormen vaakasuora liike"),
        ...
        ("Show control pad", "Näytä ohjauslevy"),
        ("Left click", "Vasen klikkaus"),
        ("Simulated wheel", "Simuloitu rulla"),
        ("Right click", "Oikea klikkaus"),
        ("Drag", "Vedä"),
        ("Middle click", "Keskiklikkaus"),
