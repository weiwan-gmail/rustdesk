...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Three-Finger horizontally", "Ba ngón theo chiều ngang"),
        ...
        ("Show control pad", "Hiện bàn điều khiển"),
        ("Left click", "Nhấp trái"),
        ("Simulated wheel", "Con lăn giả lập"),
        ("Right click", "Nhấp phải"),
        ("Drag", "Kéo"),
        ("Middle click", "Nhấp giữa"),
